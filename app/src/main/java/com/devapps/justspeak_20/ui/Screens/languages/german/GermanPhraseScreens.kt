...
import com.devapps.justspeak_20.ui.components.questionTabItems
import com.devapps.justspeak_20.ui.components.timeTabItems
    ...
    Column(
       ...
       TabRow(
        ...
        HorizontalPager(
            ...
            when(page) {
                0 -> GermanGastronomyHome(textToSpeech)
                1 -> GermanShopping(textToSpeech)
...
fun GermanQuestions() {
    ...
    Column(
        ...
        TabRow(
            ...
            questionTabItems.fastForEachIndexed { index, item ->
                Tab(
                    selected = index == selectedTabIndex,
                    onClick = {
                        selectedTabIndex = index
        ...
        HorizontalPager(
            ...
            when(page) {
                0 -> GermanQuestionHome(textToSpeech)
                1 -> GermanQuestionForm(textToSpeech)
                2 -> GermanVerbQuestion(textToSpeech)
                3 -> GermanQuestionQuiz()
            }
        }
    }
}
...
fun GermanTime() {
    ...
    Column(
        ...
        TabRow(
            ...
            timeTabItems.fastForEachIndexed { index, item ->
                Tab(
                    selected = index == selectedTabIndex,
                    onClick = {
                        selectedTabIndex = index
        ...
        HorizontalPager(
            ...
            when(page) {
                0 -> GermanTimeHome(textToSpeech)
                1 -> GermanTellTheTime(textToSpeech)
                2 -> GermanTimeQuiz()
            }
        }
    }
